...
const createPlayer = (
	...
	maxHp: number,
	isComputer = false,
	status = {isShielded: false, isSleeping: false, sleepTurnsRemaining: 0, snapBackActive: false},
	abilityCooldown = 0,
): Player => ({
	id,
	name,
	...
	args: {
		players: [
			...
			createPlayer(
				...
				100,
				false,
				{isShielded: false, isSleeping: false, sleepTurnsRemaining: 0, snapBackActive: false},
				2,
			),
		],
